...
namespace SystemDesignTutorials.ClientServerSpaApi.Infrastructure;
...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        var connectionString = configuration.GetConnectionString("DefaultConnection")
            ?? "Host=localhost;Port=5432;Database=client_server_spa_api;Username=postgres;Password=postgres";

        services.AddDbContext<ClientServerSpaApiDbContext>(options =>
        {
        ...
        services
            ...
            .AddSignInManager()
            .AddEntityFrameworkStores<ClientServerSpaApiDbContext>();
        ...
        services
            ...
            .AddIdentityCookies(options =>
            {
                ...
                {
                    cookie.Cookie.Name = "clientserverspaapi.auth";
